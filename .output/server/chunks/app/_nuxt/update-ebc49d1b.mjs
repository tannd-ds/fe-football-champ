...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    if (route.query.team_id) {
      ...
      const res = ([__temp, __restore] = withAsyncContext(() => useFetch("http://localhost:8000/api/team/edit/" + route.query.team_id, "$zd2J23qpWn")), __temp = await __temp, __restore(), __temp);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/team/update.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=update-ebc49d1b.mjs.map
