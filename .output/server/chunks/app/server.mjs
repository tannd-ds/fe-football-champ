import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, useSSRContext, useAttrs, computed, toValue, defineComponent, unref, toRef, isRef, h, resolveComponent, mergeProps, createVNode, resolveDynamicComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, onUnmounted, createApp, effectScope, reactive, provide, onErrorCaptured, onServerPrefetch, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, markRaw, isShallow, isReactive, toRaw, nextTick, Suspense, Transition, createSlots, renderList } from 'vue';
import { d as useRuntimeConfig$1, h as createError$1, l as defu, $ as $fetch, m as hasProtocol, p as parseURL, n as parseQuery, o as klona, q as createDefu$1, r as isEqual, t as createHooks, w as withTrailingSlash, v as withoutTrailingSlash, x as withQuery, y as isScriptProtocol, j as joinURL, z as sanitizeStatusCode } from '../nitro/node-server.mjs';
...
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderSlot, ssrRenderVNode, ssrRenderList, ssrRenderStyle, ssrRenderSuspense } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8d13812a.mjs').then((m) => m.default || m)
  },
  {
    name: "match",
    path: "/match",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-223867a0.mjs').then((m) => m.default || m)
  },
  {
    name: "match-update",
    path: "/match/update",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/update-ca0f260c.mjs').then((m) => m.default || m)
  },
  {
    name: "season-detail-id",
    path: "/season/detail/:id()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-2a243146.mjs').then((m) => m.default || m)
  },
  {
    name: "season",
    path: "/season",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-757774fd.mjs').then((m) => m.default || m)
  },
  {
    name: "season-update",
    path: "/season/update",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/update-87b1c7e1.mjs').then((m) => m.default || m)
  },
  {
    name: "soccer",
    path: "/soccer",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-9665541b.mjs').then((m) => m.default || m)
  },
  {
    name: "soccer-update",
    path: "/soccer/update",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/update-cf7edf4a.mjs').then((m) => m.default || m)
  },
  {
    name: "team",
    path: "/team",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d00b871f.mjs').then((m) => m.default || m)
  },
  {
    name: "team-update",
    path: "/team/update",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/update-ebc49d1b.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-47d717c3.mjs').then((m) => m.default || m)
};
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$5]]);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<template><div${ssrRenderAttrs(mergeProps({ class: _ctx.wrapperClass }, _ctx.attrs, _attrs))}><div class="${ssrRenderClass([_ctx.ui.container, _ctx.ui.rounded, _ctx.ui.ring])}"><div class="${ssrRenderClass(_ctx.ui.padding)}"><div class="${ssrRenderClass([{ "items-start": _ctx.description || _ctx.$slots.description, "items-center": !_ctx.description && !_ctx.$slots.description }, "flex gap-3"])}">`);
  if (_ctx.icon) {
    _push(ssrRenderComponent(_component_UIcon, {
      name: _ctx.icon,
      class: _ctx.iconClass
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-ea063a87.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-fd621e46.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-3948e62a.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { card as A, _export_sfc as _, __nuxt_component_0$3 as a, useRouter as b, createError as c, __nuxt_component_3 as d, entry$1 as default, __nuxt_component_1 as e, useRoute as f, useToast as g, appConfig as h, useUI as i, get as j, checkbox as k, table as l, mergeConfig as m, kbd as n, omit as o, dropdown as p, __nuxt_component_2$1 as q, __nuxt_component_0$1 as r, select as s, tooltip as t, useHead as u, formGroup as v, input as w, asyncDataDefaults as x, useNuxtApp as y, fetchDefaults as z };
