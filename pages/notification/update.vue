      ...
      <template #main>
        ...
        <UAccordion :items="advanced_settings1">
              <template #default="{ item, index, open }">
                <UButton color="gray" variant="outline" class="rounded-md" size="xl" :ui="{ rounded: 'rounded-none', padding: { sm: 'p-3' } }">
...
// }).refine(
//   data => (data.user_id !== '' && data.season_id !=='') , {
//     path: ['user_id', 'season_id'],
//     message: 'Chỉ được gửi cho mùa giải hoặc một người dùng',
//   }
// )
// .refine(
//   data => (data.user_id === '' && data.season_id ==='' ),{
